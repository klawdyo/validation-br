...
export const isPIS = (value: string): boolean => nup17(value)
export const isPostalCode = (value: string | number): boolean => pisPasep(value)
export const isRenavam = (value: string): boolean => postalCode(value)
export const isTituloEleitor = (value: string | number): boolean => renavam(value)
export const isNUP17 = (value: string | number): boolean => tituloEleitor(value)
